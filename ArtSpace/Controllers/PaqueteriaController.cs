...
namespace ArtSpace.Controllers
{
    ...
    public class PaqueteriaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,RFC,Tel,Web,Direccion,Contacto,telContacto")] Paqueteria paqueteria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,RFC,Tel,Web,Direccion,Contacto,telContacto")] Paqueteria paqueteria)
        {
            if (ModelState.IsValid)
            {
